...
import wtf.choco.meh.client.chat.ChatEmotes;
...
public final class MEHLanguageProvider extends FabricLanguageProvider {
    ...
    public void generateTranslations(Provider registryLookup, TranslationBuilder builder) {
        ...
        this.add(builder, QuantifiedTreasureType.ARENA_BRAWL_COINS, "Arena Brawl Coins");
        this.add(builder, QuantifiedTreasureType.BED_WARS_TOKENS, "Bed Wars Tokens");
        this.add(builder, QuantifiedTreasureType.BLITZ_SG_COINS, "Blitz SG Coins");
        this.add(builder, QuantifiedTreasureType.BUILD_BATTLE_TOKENS, "Build Battle Tokens");
        this.add(builder, QuantifiedTreasureType.COPS_AND_CRIMS_COINS, "Cops and Crims Coins");
        this.add(builder, QuantifiedTreasureType.DUELS_TOKENS, "Duels Tokens");
        this.add(builder, QuantifiedTreasureType.MEGA_WALLS_COINS, "Mega Walls Coins");
        this.add(builder, QuantifiedTreasureType.MURDER_MYSTERY_TOKENS, "Murder Mystery Tokens");
        this.add(builder, QuantifiedTreasureType.PAINTBALL_WARFARE_COINS, "Paintball Warfare Coins");
        this.add(builder, QuantifiedTreasureType.QUAKECRAFT_COINS, "Quakecraft Coins");
        this.add(builder, QuantifiedTreasureType.SKYWARS_COINS, "SkyWars Coins");
        this.add(builder, QuantifiedTreasureType.SMASH_HEROES_COINS, "Smash Heroes Coins");
        this.add(builder, QuantifiedTreasureType.TNT_GAMES_TOKENS, "The TNT Games Tokens");
        this.add(builder, QuantifiedTreasureType.TURBO_KART_RACERS_COINS, "Turbo Kart Racers Coins");
        this.add(builder, QuantifiedTreasureType.UHC_CHAMPIONS_COINS, "UHC Champions Coins");
        this.add(builder, QuantifiedTreasureType.VAMPIREZ_COINS, "VampireZ Coins");
        this.add(builder, QuantifiedTreasureType.WALLS_COINS, "The Walls Coins");
        this.add(builder, QuantifiedTreasureType.WARLORDS_COINS, "Warlords Coins");
        ...
        this.add(builder, ChatEmotes.ARROW, "Arrow");
        this.add(builder, ChatEmotes.CAT, "Cat");
        this.add(builder, ChatEmotes.COUNTING, "Counting");
        this.add(builder, ChatEmotes.CUTE, "Cute");
        this.add(builder, ChatEmotes.DAB, "Dab");
        this.add(builder, ChatEmotes.DJ, "DJ");
        this.add(builder, ChatEmotes.DOG, "Dog");
        this.add(builder, ChatEmotes.EXCITED_WAVE, "Excited Wave");
        this.add(builder, ChatEmotes.GIMME, "Gimme");
        this.add(builder, ChatEmotes.GLEE_LOWER, "Glee (Lower)");
        this.add(builder, ChatEmotes.GLEE_UPPER, "Glee (Upper)");
        this.add(builder, ChatEmotes.HEART, "Heart");
        this.add(builder, ChatEmotes.JAVA, "Java");
        this.add(builder, ChatEmotes.MATHS, "Maths");
        this.add(builder, ChatEmotes.NO, "No");
        this.add(builder, ChatEmotes.OOF, "OOF");
        this.add(builder, ChatEmotes.PEACE, "Peace");
        this.add(builder, ChatEmotes.PUFFER, "Puffer");
        this.add(builder, ChatEmotes.PVP, "PvP");
        this.add(builder, ChatEmotes.SHRUG, "Shrug");
        this.add(builder, ChatEmotes.SLOTH, "Sloth");
        this.add(builder, ChatEmotes.SNAIL, "Snail");
        this.add(builder, ChatEmotes.SNOWMAN, "Snowman");
        this.add(builder, ChatEmotes.STAR, "Star");
        this.add(builder, ChatEmotes.TABLE_FLIP, "Table Flip");
        this.add(builder, ChatEmotes.THINKING, "Thinking");
        this.add(builder, ChatEmotes.TOTEM, "Totem");
        this.add(builder, ChatEmotes.TYPING, "Typing...");
        this.add(builder, ChatEmotes.WAVE, "Wave");
        this.add(builder, ChatEmotes.WIZARD, "Wizard");
        this.add(builder, ChatEmotes.YES, "Yes");
        this.add(builder, ChatEmotes.YEY, "yey");
